    ...
    return (mapper) => {
      ...
      createMap(
        ...
        forMember(
          (dest) => dest.seats,
          mapFrom((source) =>
            mapper.mapArray(source.seats, Seat, SeatDetailsViewDto),
          ),
        ),
      );
      ...
      createMap(
        ...
        forMember(
          (dest) => dest.rows,
          mapFrom((source) =>
            mapper.mapArray(source.rows, Row, RowDetailsViewDto),
          ),
        ),
      );
      ...
      createMap(
        ...
        forMember(
          (dest) => dest.movie,
          mapFrom((source) =>
            mapper.map(source.movie, Movie, MovieDetailsViewDto),
          ),
        ),
        forMember(
          (dest) => dest.hall,
          mapFrom((source) =>
            mapper.map(source.hall, Hall, HallDetailsViewDto),
          ),
        ),
      );
    };
